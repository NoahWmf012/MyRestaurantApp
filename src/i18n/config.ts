...
import zhCNAuth from './locales/zh/auth.json'
import zhCNRestaurant from './locales/zh/restaurant.json'
import zhCNProfile from './locales/zh/profile.json'
import zhCNVote from './locales/zh/vote.json'
